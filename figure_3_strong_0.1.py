...
###This notebook creates velocity streamlines and combines it with deformation image generated from Grid_deformation_strong_0.1_figure_3.nb  
...
X = np.loadtxt('velocity_x_strong_0.1_figure_3.txt', comments='%')[:,0] #exported from strong_acid_2D.mph
Y = np.loadtxt('velocity_x_strong_0.1_figure_3.txt', comments='%')[:,1]
U = np.loadtxt('velocity_x_strong_0.1_figure_3.txt', comments='%')[:,2:]
V = np.loadtxt('velocity_y_strong_0.1_figure_3.txt', comments='%')[:,2:] #exported from strong_acid_2D.mph
X_sol = np.loadtxt('sol_vel_x_strong_0.1_figure_3.txt', comments='%')[:,0] #exported from strong_acid_2D.mph
Y_sol = np.loadtxt('sol_vel_x_strong_0.1_figure_3.txt', comments='%')[:,1]
U_sol = np.loadtxt('sol_vel_x_strong_0.1_figure_3.txt', comments='%')[:,2:]
V_sol = np.loadtxt('sol_vel_y_strong_0.1_figure_3.txt', comments='%')[:,2:] #exported from strong_acid_2D.mph
...
def speedplot(n):
    ...
    plt.savefig('./velocity_strong_0.1_figure_3_2.png', bbox_inches='tight', pad_inches=0,dpi=300, transparent=True)
    #plt.close(fig)
    speed_intp=[]
    V_grid=[]
    U_grid=[]
...
img1 = plt.imread('velocity_strong_0.1_figure_3_2.png')
img2 = plt.imread('deform_strong_0.1_figure_3.png')
fig, ax =  plt.subplots(figsize=(50,20))
...
plt.xlim(128,672)
plt.title(f'{0.1:.2f}'+r'$\tau$', fontsize=120)
plt.savefig('final_t_0.1_strong_0.1_figure_3_2.png', dpi=300, pad_inches=0, bbox_inches='tight')
#plt.close(fig)
