...
###This notebook creates velocity streamlines and combines it with deformation image generated from Grid_deformation_weak_16_figure_3.nb  
...
X = np.loadtxt('velocity_x_weak_16_figure_3.txt', comments='%')[:,0] #exported from weak_acid_2D.mph
Y = np.loadtxt('velocity_x_weak_16_figure_3.txt', comments='%')[:,1]
U = np.loadtxt('velocity_x_weak_16_figure_3.txt', comments='%')[:,2:]
V = np.loadtxt('velocity_y_weak_16_figure_3.txt', comments='%')[:,2:] #exported from weak_acid_2D.mph
X_sol = np.loadtxt('sol_vel_x_weak_16_figure_3.txt', comments='%')[:,0] #exported from weak_acid_2D.mph
Y_sol = np.loadtxt('sol_vel_x_weak_16_figure_3.txt', comments='%')[:,1]
U_sol = np.loadtxt('sol_vel_x_weak_16_figure_3.txt', comments='%')[:,2:]
V_sol = np.loadtxt('sol_vel_y_weak_16_figure_3.txt', comments='%')[:,2:] #exported from weak_acid_2D.mph
...
X_start = np.linspace(0.2,0.8,16)
Y_start = np.linspace(0,2,11)
...
def speedplot(n):
    ...
    streamplot(ax,X_grid, Y_grid, U_grid, V_grid, linewidth=lw, density=(1,6), start_points=start_grid,color='red', maxlength = 0.1, minlength=0.01)
    ax.axis('off')
    #fig.colorbar(pcm, location='bottom')
    plt.savefig('./velocity_weak_16_figure_3.png', bbox_inches='tight', pad_inches=0,dpi=300, transparent=True)
    plt.close(fig)
    speed_intp=[]
    V_grid=[]
    U_grid=[]
...
img1 = plt.imread('velocity_weak_16_figure_3.png')
img2 = plt.imread('deform_weak_16_figure_3.png')
fig, ax =  plt.subplots(figsize=(50,20))
...
plt.xlim(288,512)
plt.title(f'{16:.2f}'+r'$\tau$', fontsize=120)
plt.savefig('final_t_16_weak_16_figure_3.png', dpi=300, pad_inches=0, bbox_inches='tight')
#plt.close(fig)
