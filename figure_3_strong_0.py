...
###This notebook creates velocity streamlines and combines it with deformation image generated from Grid_deformation_strong_0_figure_3.nb  
...
X = np.loadtxt('velocity_x_strong_0_figure_3.txt', comments='%')[:,0] #exported from strong_acid_2D.mph
Y = np.loadtxt('velocity_x_strong_0_figure_3.txt', comments='%')[:,1]
U = np.loadtxt('velocity_x_strong_0_figure_3.txt', comments='%')[:,2:]
V = np.loadtxt('velocity_y_strong_0_figure_3.txt', comments='%')[:,2:] #exported from strong_acid_2D.mph
X_sol = np.loadtxt('sol_vel_x_strong_0_figure_3.txt', comments='%')[:,0] #exported from strong_acid_2D.mph
Y_sol = np.loadtxt('sol_vel_x_strong_0_figure_3.txt', comments='%')[:,1]
U_sol = np.loadtxt('sol_vel_x_strong_0_figure_3.txt', comments='%')[:,2:]
V_sol = np.loadtxt('sol_vel_y_strong_0_figure_3.txt', comments='%')[:,2:] #exported from strong_acid_2D.mph
...
def speedplot(n):
    ...
    plt.savefig('./velocity_strong_0_figure_3.png', bbox_inches='tight', pad_inches=0,dpi=300, transparent=True)
    #plt.close(fig)
    speed_intp=[]
    V_grid=[]
    U_grid=[]
...
img1 = plt.imread('velocity_strong_0_figure_3.png')
img2 = plt.imread('deform_strong_0_figure_3.png')
fig, ax =  plt.subplots(figsize=(50,20))
...
ax.tick_params(axis="x",direction="inout", length=60, width=6, labelsize=100)
ax.tick_params(axis="y",direction="inout", length=60, width=6, labelsize=100)
for axis in  ['top','bottom','left','right']:
    ax.spines[axis].set_linewidth(6)
ax.spines[['right', 'top']].set_visible(False)
plt.title(f'{0:.2f}'+r'$\tau$', fontsize=100)
plt.savefig('final_t_0_strong_0_figure_3.png', dpi=300, pad_inches=0, bbox_inches='tight')
#plt.close(fig)
