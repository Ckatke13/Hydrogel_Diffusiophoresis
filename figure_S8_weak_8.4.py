...
###This notebook creates velocity streamlines and combines it with deformation image generated from Grid_deformation_vector_3.nb  
...
X = np.loadtxt('velocity_x_weak_8.4_figure_3.txt', comments='%')[:,0] #exported from weak_acid_2D.mph
Y = np.loadtxt('velocity_x_weak_8.4_figure_3.txt', comments='%')[:,1]
U = np.loadtxt('velocity_x_weak_8.4_figure_3.txt', comments='%')[:,2:]
V = np.loadtxt('velocity_y_weak_8.4_figure_3.txt', comments='%')[:,2:] #exported from weak_acid_2D.mph
X_sol = np.loadtxt('sol_vel_x_weak_8.4_figure_3.txt', comments='%')[:,0] #exported from weak_acid_2D.mph
Y_sol = np.loadtxt('sol_vel_x_weak_8.4_figure_3.txt', comments='%')[:,1]
U_sol = np.loadtxt('sol_vel_x_weak_8.4_figure_3.txt', comments='%')[:,2:]
V_sol = np.loadtxt('sol_vel_y_weak_8.4_figure_3.txt', comments='%')[:,2:] #exported from weak_acid_2D.mph
...
def speedplot(n):
    ...
    U_grid[speed_intp<0.0001]=0
    V_grid[speed_intp<0.0001]=0
    speed_intp[speed_intp<0.0001]=0.0001
    lw = ma.log(speed_intp/max_speed) + 8
    lw.filled(0)
    ...
    plt.savefig('./velocity_weak_8.4_figure_3.png', bbox_inches='tight', pad_inches=0,dpi=300, transparent=True)
    plt.close(fig)
    speed_intp=[]
    V_grid=[]
    U_grid=[]
...
img1 = plt.imread('velocity_weak_8.4_figure_3.png')
img2 = plt.imread('deform_weak_8.4_figure_3.png')#output of Grid_deformation_weak_8.4_figure_3.nb
fig, ax =  plt.subplots(figsize=(50,20))
...
#plt.xlim(288,512)
plt.title(f'{8.4:.2f}'+r'$\tau$', fontsize=120)
plt.savefig('final_t_8.4_weak_8.4_figure_3.png', dpi=300, pad_inches=0, bbox_inches='tight')
#plt.close(fig)
