...
###This notebook creates velocity streamlines and combines it with deformation image generated from Grid_deformation_weak_24_figure_3.nb  
...
X = np.loadtxt('velocity_x_weak_24_figure_3.txt', comments='%')[:,0] #exported from weak_acid_2D.mph
Y = np.loadtxt('velocity_x_weak_24_figure_3.txt', comments='%')[:,1]
U = np.loadtxt('velocity_x_weak_24_figure_3.txt', comments='%')[:,2:]
V = np.loadtxt('velocity_y_weak_24_figure_3.txt', comments='%')[:,2:] #exported from weak_acid_2D.mph
X_sol = np.loadtxt('sol_vel_x_weak_24_figure_3.txt', comments='%')[:,0] #exported from weak_acid_2D.mph
Y_sol = np.loadtxt('sol_vel_x_weak_24_figure_3.txt', comments='%')[:,1]
U_sol = np.loadtxt('sol_vel_x_weak_24_figure_3.txt', comments='%')[:,2:]
V_sol = np.loadtxt('sol_vel_y_weak_24_figure_3.txt', comments='%')[:,2:] #exported from weak_acid_2D.mph
...
X_start = np.linspace(0.2,0.8,11)
...
def speedplot(n):
    ...
    plt.savefig('./velocity_weak_24_figure_3.png', bbox_inches='tight', pad_inches=0,dpi=300, transparent=True)
    #plt.close(fig)
    speed_intp=[]
    V_grid=[]
    U_grid=[]
...
img1 = plt.imread('velocity_weak_24_figure_3.png')
img2 = plt.imread('deform_weak_24_figure_3.png')
fig, ax =  plt.subplots(figsize=(50,20))
...
plt.xlim(288,512)
plt.title(f'{24:.2f}'+r'$\tau$', fontsize=120)
plt.savefig('final_t_24_weak_24_figure_3.png', dpi=300, pad_inches=0, bbox_inches='tight')
#plt.close(fig)
